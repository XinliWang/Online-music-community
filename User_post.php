...
$stmt1 = $conn->prepare("Select * from Venue");
$stmt1->execute();
?>
    ...
    <ul class="columns-content page-content clearfix">
        ...
        <li class="col-main">
            ...
            <div class="blog-content clearfix">
                ...
                <form method="post" enctype="multipart/form-data" action="Artist_post_add.php"
                      onsubmit="return checkForm();">
                    <table>
                        <tr>
                            <td> ConcertName</td>
                            <td><input type="text" name="concertName" id="concertName"/><span id="usernameInfo"></span>
                            </td>
                        </tr>
                        <tr>
                            <td> Time</td>
                            ...
                            <td>
                                ...
                                <select name="location">
                                    ...
                                    while($row1 = $stmt1->fetch()) {
                                        ?>
                                        <option value="<?= $row1[Venue_Id] ?>"><?= $row1[Venue_Name] ?></option>
                                    <?php
                                    } $conn = null;
                        ...
                        <tr>
                            <td> TicketHyperlink</td>
                            <td><input type="url" name="ticketHyperlink" id="ticketHyperlink"/></td>
                        </tr>
                        <tr>
                            <td> Price</td>
                        ...
                        <tr>
                            <td> Ticket availabilities</td>
                            <td><input type="number" name="quantity" min="0" max="1000"/></td>
                        </tr>
                        <tr>
                            <td> Introduction</td>
                            <td><textarea rows="6" cols="200" name="description" id="description"></textarea></td>
