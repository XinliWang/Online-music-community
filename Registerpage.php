...
<div class="wrapper">
    ...
    if(!isset($_COOKIE["user_id"])) {
        ...
        <ul class=\"clearfix\">
            ...
            <li class=\"myaccount-icon\"><a href=\"Register.html\">Sign up</a></li>
        </ul>
        ...
        <ul class="columns-2 checkout-form clearfix">
            <li class="col2 clearfix">
                ...
                <div class="tag-title-wrap clearfix">
                    <h4 class="tag-title">Rigister</h4>
                </div>

                <input class="half-input fl" type="text" name="user_name" onblur="if(this.value=='')this.value='User name';" onfocus="if(this.value=='User name')this.value='';" value="User name" />
                <input class="half-input fr" type="password" name="user_pwd" onblur="if(this.value=='Password')this.value='Password';" onfocus="if(this.value=='Password')this.value='Password';" value="Password" />
                <input class="half-input fl" type="text" name="DoB" onblur="if(this.value=='DoB')this.value='DoB';" onfocus="if(this.value=='DoB')this.value='';" value="DoB" />
                <input class="half-input fr" type="text" name="city" onblur="if(this.value=='')this.value='City';" onfocus="if(this.value=='City')this.value='';" value="City" />
                <input class="half-input fl" type="text" name="email-address" onblur="if(this.value=='')this.value='Email Address';" onfocus="if(this.value=='Email Address')this.value='';" value="Email Address" />
            </li>
        </ul>
        <input class="button2 fr" type="submit" value="Register &raquo;" id="submit" name="submit" />
    </div>
    </form>
