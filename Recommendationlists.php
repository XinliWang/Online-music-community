    ...
    <ul class="columns-content page-content clearfix">
        ...
        <li class="col-main">
            ...
            <div class="blog-content clearfix">
                ...
                <form method="post" enctype="multipart/form-data" action="Recommendlist_post_add.php">
                    <table>
                        <tr>
                            <td> Recommendlist_Name</td>
                            <td><input type="text" name="Recommendlist_Name" id="Recommendlist_Name"/>
                            </td>
                        </tr>
